...
{  
	...
	$wp_customize->add_setting( 'construction_excerpt_length', array(
        'default'=>30,
        'type'=>'theme_mod',
		...
		'settings'   => 'construction_excerpt_length'
    ) );
	...
	'title'=>__("Documentation","wp-construction"),
	'panel'=>'wp_construction_theme_option',
	'capability'=>'edit_theme_options',
    'priority' => 50,
	));
	...
	$wp_customize->add_control(new wp_construction_documentaion($wp_customize, 'doc', array(
...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'wp_construction_documentaion' ) ) :
class wp_construction_documentaion extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label style="overflow: hidden; zoom: 1;">
			<div class="col-md-2 col-sm-6 upsell-btn">					
					<h2 style="padding: 10px;text-align: center;color: #fff;background-color: #ffb434;"> Construction Documentaion </h2>
			</div>		
			<div class="col-md-3 col-sm-6">
			<h3 style="text-align: center;font-size: 16px; text-shadow: 1px 1px 1px #ccc;"> Home Options </h3>
					<ol>
						<li><b>General Options -</b> General Options use for logo width and height, add search box on header, sticky header and add custom css.</li>
						<li><b>Theme Slider Options - </b> It is use to add slider image, title, description and enable/disable slider on homepage.</li>
						<li><b>Home Blog Options - </b> Use to add blog title, description, blog excerpt length and enable/disable blog section on homepage,number of blogs on homepage and select category.</li>
						<li><b>Social Options -</b> enable/disable social option on header and footer, add social links, phone number, address and Email-ID.</li>
						<li><b>Footer Options-</b> Use to add Customization text, developed by text and developed by link.</li>
					</ol>
			</div>	
		</label>
		<?php
