 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Construction_Field_About' ) ) {

	class Construction_Field_About extends WP_Widget {
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__( 'AT About Section', 'construction-field' ),
                    /*Widget description*/
                    array(
		...
		public function form( $instance ) {
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'column_number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'column_number' ) ); ?>">
					<?php
					$construction_field_about_column_numbers = construction_field_widget_column_number();
					foreach ( $construction_field_about_column_numbers as $key => $value ) {
						?>
                ...
                <div class="container">
                    ...
                    <div class="row">
						...
						if( !empty( $post_in )) :
							...
							$about_query = new WP_Query( $construction_field_post_in_page_args );
	...
	} // Class Construction_Field_About ends here
}